...
@ManagedBean (name="vistaRecurso")
@ViewScoped

public class VistaRecurso implements Serializable{
    private static final long serialVersionUID = 6606777227575594107L;

  learningObject  objeto = new learningObject();; 
  String id;
  Estilo estilo;
