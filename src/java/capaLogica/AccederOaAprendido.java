...
@ManagedBean(name = "accederOaAprendido")
@SessionScoped

public class AccederOaAprendido implements Serializable {

    private static final long serialVersionUID = -7108557027796373791L;
    ...
    private ArrayList<learningObject> objetos2;

    public ArrayList<learningObject> getObjetos2() {
        return objetos2;
    }

    public void setObjetos2(ArrayList<learningObject> objetos2) {
    ...
    public void mostrarResultados() {
        ...
        try {
            objetos = Retorno.leerNombreTopico();

            objetos2 = Retorno.leerRecursoOaAprendido(idTopicoSeleccionado);//Aqui va a buscar los objetos ordenados DESC
            
            System.out.println("Obejto2"+ objetos2);
            System.out.println("Objetos:"+objetos);
            for (learningObject objeto2 : objetos2) {
                System.out.println("Derechos Objeto2:" + objeto2.getAutor());
                System.out.println("Contenido objetos2:" + objeto2);
            }
...
/*
        try {
            ...
            contex.getExternalContext().redirect("/AppTituloProyecto/faces/Estudiante/ViewRecurso.xhtml?idRecurso=" + objetoUnit.getId());
        } catch (Exception e) {
