...
public class EstudianteEstilo {
    ...
    public EstudianteEstilo(String correo, String nombre1, String nombre2, String nombre3, String nombre4, String nombre5, String nombre6, String nombre7, String nombre8) {
        this.correo = correo;
