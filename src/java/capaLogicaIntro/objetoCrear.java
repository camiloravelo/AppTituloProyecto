...
@ManagedBean(name = "objetoCrearIntro")
@ViewScoped
public class objetoCrear implements Serializable {
    ...
    public void procesar() {
        ...
        if (!oa.getTitulo().equals("") && !oa.getDescripcion().equals("") && !oa.getAutor().equals("") && !oa.getFecha().equals("") && !oa.getVersion().equals("") && !oa.getDerechos().equals("")) {
            ...
            //String destination = "/Users/robby/NetBeansProjects/AppTitulo2/web/resources/objetos/";
            ...
            try {
                ...
                contex.getExternalContext().redirect("/AppTitulo2/faces/Profesor/gestionarRecursos.xhtml");
