...
import OntologiaIntro.Inserciones;
...
@ManagedBean (name="tablaLearningObjectIntro")
@ViewScoped
public class TablaLearningObject {
    ...
    public void verObjeto(String id) {
        ...
        try {
            ...
            contex.getExternalContext().redirect("/AppTitulo2/faces/Profesor/ViewRecurso.xhtml?idRecurso=" + objetoUnit.getId());
        } catch (Exception e) {
