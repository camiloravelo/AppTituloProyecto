 ...
 */
@ManagedBean
public class ChartViewIntro implements Serializable{
 ...
 private ArrayList<Estilo> Estilo;
    ...
    private void createPieModel1() {
        ...
        dim1valor2 = f12.size();
        pieModel11.set("Sensitivo", dim1valor1);
        pieModel11.set("Intuitivo", dim1valor2);
        pieModel11.setShowDataLabels(true);
        pieModel11.setTitle("Percepción");
